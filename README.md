...
```bash
docker exec -it pm4py-llm-app-container python3 -m utils.random_sample_selection.py
```
...
```bash
docker exec -it pm4py-llm-app-container python3 -m utils.merge_abstract_dfgs_to_json.py
```
...
```bash
docker exec -it pm4py-llm-app-container python3 -m utils.dfg_to_png.py
```
